                    ...
                    <div id="all-floors">
                        <div class="brandlist">
                            ...
                            @foreach($merchants as $key => $merchant)
                                <?php $count++ ?>
                                    @if($firstLetter != substr($merchant->company_name, 0, 1))
                                        <?php $firstLetter =  substr($merchant->company_name, 0, 1); ?>
                                        @if(!$firstRun)
                                            </li>
                                            </ul>
                                            </div>
                                        ...
                                        <ul>
                                    @endif
                                        <li><a href="{{ route('oshop.one', [$merchant->id]) }}">{{ $merchant->company_name }}</a></li>
                            @endforeach
                            <p>&nbsp;</p>
                            </li>
                            </ul>
