...
<div class="container">
  <div class="row" style="margin-top:-36px;">
      ...
      <div class="panel panel-default">
          <label for="comment" style="padding-left:10px;"><h2>Privacy Policy:</h2></label>
          <div class="form-group">
             @if (Session::has("unsuccess"))
              ...
              @endif
            <textarea class="form-control" rows="5" id="comment" style="height:600px ; width:95%; margin:20px; margin-right:20px" placeholder="Load Private Policy" onblur="validate()" required>
                Privacy Policy
                ...
                Data protection is a matter of trust and your privacy is important to us. We shall therefore only process your name and other information which relates to you in the manner set out in this Privacy Policy.
                Intermedius OpenSupermall Sdn Bhd and its affiliates ("Company"), may take your personal information when you communicate with us either by log in to our website or contact to our customer service and the information that we collected from you may be used and will be kept confidential. In order to protect your private information, we have established this Privacy Policy (the "Policy") in accordance with best practices in the industry and applicable laws and regulations. This Policy describes how we handle your personal information for our services on the opensupermall.com website and its related sites, services and tools (the "Website").
                By accepting the Policy, Terms & Conditions in registration, you expressly consent to our collection, storage, use and disclosure of your personal information as described in this Policy.
                ...
                o email address, physical contact information, the date of birth and gender information, and (depending on the service used) sometimes financial information, such as credit card or bank account numbers;
                o transactional information based on your activities on the Website
                o postage, billing and other information you provide to purchase or dispatch an item;
                o community discussions, chats, dispute resolution, correspondence through our Website, and correspondence sent to us;
                o other information from your interaction with our Website, services, content and advertising, including computer and connection information, statistics on page views, traffic to and from the Website, ad data, IP address and standard web log information;
                o additional information we ask you to submit to authenticate yourself or if we believe you are violating site policies (for example, we may ask you to send us an ID or bill to verify your address, or to answer additional questions online to help verify your identity or ownership of an item you list);
                o information from other companies, such as demographic and navigation data; and
                o other supplemental information from third parties (for example, if you incur a debt to the Company, we will generally conduct a credit check by obtaining additional information about you from a credit bureau, as permitted by law).
                ...
                o Prevent potentially prohibited or illegal activities, and enforce our User Agreement;
                o Customize, measure and improve our services, content and advertising;
                o Tell you about our services and those of our corporate family;
                o Send you targeted marketing, service updates, and promotional offers; and
                o Compare information for accuracy, and verify it with third parties.
                o Provide aggregate information to our partners about our users (e.g. 500 men under age 30 have viewed this item) without disclosing information about identifiable individuals.
                ...
                o Third-party service providers under contract who help with our business operations: We employ other companies and individuals to perform functions on our behalf. Examples include fulfilling orders, delivering packages, sending postal mail and e-mail, removing repetitive information from customer lists, analyzing data, providing marketing assistance, providing search results and links(including paid listings and links), processing credit card payments, investigating frauds and providing customer service. They have access to personal information needed to perform their functions, but may not use it for other purposes.
                o Third parties giving promotional offers: Sometimes we send offers to selected groups our users on behalf of other businesses. When we do this, we do not give that business your name and address. If you do not want to receive such offers, please adjust communication preferences in My Page.
                o Other third parties to whom you explicitly ask us to send your information (or about whom you are otherwise explicitly notified and consent to when using a specific service).
                o Law enforcement or other governmental officials, in response to a verified request relating to a criminal investigation or alleged illegal activity. In such events, we will disclose information relevant to the investigation, such as name, city, postal code, telephone number, email address, User ID history, IP address, fraud complaints, and purchasing and listing history;
                o Brand Protection Program participants under confidentiality agreement, as we in our sole discretion believe necessary or appropriate in connection with an investigation of fraud, intellectual property infringement, piracy, or other unlawful activity. In such events, we will disclose name, street address, city, postal code,country, phone number, email address and company name; and
                o Other business entities, should we plan to merge with or be acquired by that business entity. (Should such a combination occur, we will require that the new combined entity follow this Policy with respect to your personal information. If your personal information will be used contrary to this policy, you will receive prior notice.)
                ...
                o fulfillment of the transaction through this website and purposes related to the transaction;
                o using services offered through this website (e.g. escrow, postage and fraud complaints); or
                ...
                Intermedius Open Supermall Sdn Bhd reserves the right to modify and change the Privacy Policy Policy at any time. Any changes to this policy will be published on our website. You should check this Policy each time you access our website so as to be aware of the most recent applicable version of the Policy.
