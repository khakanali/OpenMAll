...
<section class="jobportal">
	<div class="container"><!--Begin main cotainer-->
		<div class="row">
			...
			<div class="col-sm-12 jobportal-banner">
...
<div class="jobportalModal modal fade" id="jobportalModalm" tabindex="-1" role="dialog" aria-labelledby="jobportalModalm">
	<div class="modal-dialog" role="document">
		<div class="modal-content" style="background-color:rgba(187, 225, 212, .85)">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-self col-sm-2" type="button" style="background-color: rgb(39,169,138)">send</button>
			</div>
		</div>
	</div>
</div>
...
<div class="jobportalModal modal fade" id="jobportalModalw" tabindex="-1" role="dialog" aria-labelledby="jobportalModalw">
	<div class="modal-dialog" role="document">
		<div class="modal-content"  style="background-color:rgba(173, 131, 141, 0.85)">
			...
			<div class="modal-footer">
				<label class="col-sm-10 text-left margin-top">Email: qiaohua.intermedius@gmail.com</label>
				<button class="btn btn-self col-sm-2" type="button" style="background-color:rgb(255,0,128)">send</button>
			</div>
		</div>
	</div>
</div>
...
<div class="jobportalModal modal fade" id="jobportalModalo" tabindex="-1" role="dialog" aria-labelledby="jobportalModalo">
	<div class="modal-dialog" role="document">
		<div class="modal-content"  style="background-color:rgba(162, 111, 92, .85)">
			...
			<div class="modal-footer">
				<label class="col-sm-10 text-left margin-top">Email: qiaohua.intermedius@gmail.com</label>
				<button class="btn btn-self col-sm-2" type="button" style="background-color:rgb(194, 125, 85)">send</button>
			</div>
		</div>
	</div>
</div>
