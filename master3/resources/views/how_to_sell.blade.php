					...
					<div class="part-one-content">
						<div class="part-one-content-heading">
							...
							<div class="part-one-content-desc">
								<p> > Fill up a merchant registration from (link)</p>
								<p> > One of our Merchant Consultants will contact you to complete the registration process.</p>
					...
					<div class="part-two-content">
						<div class="part-two-content-heading">
							<div class="part-two-content-desc">
								<p> After successful registration,login to your merchant profile.</p>
							</div>
						</div>
					</div><!-- part-two-content end -->

					<div class="part-two-image">
						{!! Html::image("images/computer.jpg", "Welcome") !!}
				...
				<div class="part-four">
					...
					<div class="part-four-content">
						<div class="part-four-content-heading">
							...
							<div class="part-four-content-desc desc-width-sell">
								<p> > Describe your product and add photos.</p>
					...
					<div class="part-five-content override-five-content">
						<div class="part-five-content-heading">
							...
							<div class="part-five-content-desc">
								<p> > Keep track of your confirmed orders </p>
								<p>by heading to order management.</p>
							</div>
					...
					<div class="part-svn-content">
						<div class="part-svn-content-heading">
							...
							<div class="part-svn-content-desc">
								<p> > Pack you order and send them via the customer's preffred shipping option within 3 business days.</p>
								<p> > Then update the product delivery status by keying in the tracking number and delivery service.</p>
							</div>
							<div class="clearfix"></div>
					...
					<div class="part-nine-content">
						<div class="part-nine-content-heading">
							...
							<div class="part-nine-content-desc">
								<p> > After completing the delivery process without any dispute / cancellation, you will receive the settlement to your registered bank account.</p>
							</div>
							{{-- <div class="clearfix"></div> --}}
