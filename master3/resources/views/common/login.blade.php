                    ...
                    <div class="col-md-12 modal-inside">
                        <form  id="loginForm"
                            ...
                            <div class="login-content">
                                ...
                                <h5>For enquery please fill in the information below</h5><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8" style='padding-left: 0px'>
                                        <input type='password' name="password" class="form-control input-sm"  placeholder="password"
                                               data-bv-trigger="keyup" required data-bv-notempty-message="Password is required">
                                     </div>
                        ...
                        <div class="row">
                            <div class="m-footer">
                                <div class="col-md-6" style='text-align: left; padding-left: 0px'>
                                    <h5> <a target="_blank" style="color:#fff;" href="http://facebook.com/"> <u>Sign in with</u> &nbsp;<span>
                                                <img alt="" src="images/fb.png" style='width:40px; height:40px;'></span></a></h5>
                                </div>
                                <div class="col-md-6">
